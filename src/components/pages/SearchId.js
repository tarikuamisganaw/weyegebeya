...
const SearchId = ({ onsetSearchQuery}) => {
  ...
  return (
    ...
    <div className="search__container" style={{height:'78px',marginBottom:'0px'}}>
      <div className='logo' style={{width: '500px', marginLeft: '3px', }}> Weye Gebeya</div>
      
      <div className="search__form" style={{marginLeft: '10px'}}>
        <img className="search__formic" src={search} alt="search" />
        <input className="search__formi" type="text" placeholder="Search by name or id"    value={searchQuery} 
